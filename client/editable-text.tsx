        ...
        if (isEditing) {
            return (<form mix={[
                ...
                on<HTMLFormElement, "submit">("submit", submitEditing)
					...
					<input required maxLength={120} id={props.id} type="text" name="value" aria-label={props.ariaLabel} autocomplete="off" value={draftValue} disabled={isSaving} mix={[
                css({
                    display: 'block',
                    width: 'auto',
                    maxWidth: '100%',
                ...
                on<HTMLInputElement, "keydown">("keydown", handleDraftKeyDown)
            ]}/>
				</form>);
        }
        return (<button id={buttonId} type="button" mix={[
            css({
                display: 'block',
                width: '100%',
                padding: 0,
            ...
            on<HTMLButtonElement, "click">("click", startEditing)
        ]}>
